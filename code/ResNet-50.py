...
#输出结果
predict(net,test_iter,r"C:\Users\TS.1989\Desktop\黄枢炜\项目\Classify Leaves\data\results_resnet50.csv",device=device)
#逆编码输出结果
inverse_label(r"C:\Users\TS.1989\Desktop\黄枢炜\项目\Classify Leaves\data\train.csv",r"C:\Users\TS.1989\Desktop\黄枢炜\项目\Classify Leaves\data\results_resnet50.csv")